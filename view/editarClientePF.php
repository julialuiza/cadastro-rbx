<?php
	...
	require "../model/consultaPF.php";
?>
<!DOCTYPE html>
<html>
<head>
	<title>Edita Cliente - PF</title>
	...
	<div class="container bg-white card p-3" id="cadForm">
		...
		<table class="table">
			 <thead class="bg-light">
			    <tr>
			      <th scope="col" class="text-dark">Editar Cliente - Pessoa Física</th>
			    </tr>
			  </thead>
	  	</table>
	  	<table class="table">
		...
		<form action="../controller/salvaClientePf.php" method="POST">
			  <div class="form-row">
			    <div class="col-md-4 mb-3">
			      <label for="validationDefault01">CPF<span class="text-danger"> *</span></label>
			      <input type="text" class="form-control" id="validationDefault01" placeholder="digite o CPF aqui" name="cpfPF" value="<?php echo $cpf;?>" readonly required>
			    </div>
			    <div class="col-md-4 mb-3">
			    ...
			    <div class="col-md-4 mb-3">
			      ...
			      <input type="text" class="form-control" id="validationDefault01" placeholder="digite o RG aqui" name="rgPF" value="<?php echo $rg;?>">
			    </div>
			  </div>
			  <hr>
			  <div class="form-row">
			    <div class="col-md-6 mb-3">
			      ...
			      <input type="text" class="form-control" id="validationDefault03" placeholder="digite o nome aqui" name="nomePF" value="<?php echo $nome;?>" required>
			    </div>
			    <div class="col-md-3 mb-3">
			      <label for="validationDefault04">Sigla/Apelido</label>
			      <input type="text" class="form-control" id="validationDefault04" placeholder="digite a sigla/apelido aqui" name="siglaPF" value="<?php echo $sigla;?>" required>
			    </div>
			    <div class="col-md-3 mb-3">
			      <label for="validationDefault05">Nascimento</label>
			      <input type="date" class="form-control" id="validationDefault05" name="dataNasPF" value="<?php echo $nascimento;?>" required>
			    </div>
			  </div>
			  <div class="form-row">
			  ...
			  <div class="form-row">
			    <div class="col-md-4 mb-3">
			      ...
			      <input type="text" class="form-control" id="validationDefault01" name="cepPF" required value="<?php echo $cep;?>">
			    </div>
			    <div class="col-md-4 mb-3">
			      ...
			      <input type="text" class="form-control" id="validationDefault01" name="cidadePF" value="<?php echo $cidade;?>" required>
			  	</div>
			  </div>
			  <div class="form-row">
			    <div class="col-md-4 mb-3">
			      <label for="validationDefault01">Endereço<span class="text-danger"> *</span></label>
			      <input type="text" class="form-control" id="validationDefault01" name="enderecoPF" required value="<?php echo $endereco;?>">
			    </div>
			    <div class="col-md-4 mb-3">
			      <label for="validationDefault01">Nº</label>
			      <input type="text" class="form-control" id="validationDefault01" name="numeroPF" value="<?php echo $numero;?>" required>
			  	</div>
			  	<div class="col-md-4 mb-3">
			      <label for="validationDefault01">Complemento<span class="text-danger"> *</span></label>
			      <input type="text" class="form-control" id="validationDefault01" name="complementoPF" value="<?php echo $complemento;?>" required>
			  	</div>
			  </div>
			  <div class="form-row">
			    <div class="col-md-4 mb-3">
			      <label for="validationDefault01">Bairro<span class="text-danger"> *</span></label>
			      <input type="text" class="form-control" id="validationDefault01" name="bairroPF" value="<?php echo $bairro;?>" required>
			    </div>
			    <div class="col-md-4 mb-3">
			      <label for="validationDefault01">Distrito</label>
			      <input type="text" class="form-control" id="validationDefault01" name="distritoPF" value="<?php echo $distrito;?>" required>
			  	</div>
			  	<div class="col-md-4 mb-3">
			  	</div>
			  </div>
